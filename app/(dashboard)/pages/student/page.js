...
const Users = () => {
  ...
  const users = [
    { name: 'Rigzin', address: 'Phuentsholing', email: 'rigzin@gmail.com', contact: '+(975) 17935412' },
    { name: 'Samdrup', address: 'Chhukha', email: 'samdrup@gmail.com', contact: '+(975) 17984838' }
  ];
